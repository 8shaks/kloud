...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, errors, isValid, _b, username, password, user, isMatch, payload, err_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = login_1.default(req.body), errors = _a.errors, isValid = _a.isValid;
                if (!isValid) {
            ...
            case 3:
                ...
                jsonwebtoken_1.default.sign(payload, keys.secretOrKey, { expiresIn: 360000 }, function (err, token) {
                    console.log(err);
                    if (err)
                        throw err;
