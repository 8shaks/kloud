...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, errors, isValid, _b, username, email, password, userEmail, userNameSearch, user, salt, _c, profile, err_1;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _a = register_1.default(req.body), errors = _a.errors, isValid = _a.isValid;
                if (!isValid) {
                    console.log(errors);
                    return [2 /*return*/, res.status(400).json({ errors: errors })];
                }
                _b = req.body, username = _b.username, email = _b.email, password = _b.password;
                _d.label = 1;
            case 1:
                _d.trys.push([1, 8, , 9]);
